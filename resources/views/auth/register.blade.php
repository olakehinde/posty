...
@section('content')
    <div class="flex pt-4 justify-center">
        <div class="w-4/12 bg-white p-6 rounded-lg"> 
            <p class="mb-2">Enter registration details.</p>
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="username" id="username" placeholder="Enter a username" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('username') border-red-500 @enderror" value="{{ old('username')}}">
